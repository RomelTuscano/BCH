package test.java.interview.treatment.plan;

import main.java.interview.treatment.plan.Clinic;
import main.java.interview.treatment.plan.Disease;
import main.java.interview.treatment.plan.Medication;
import main.java.interview.treatment.plan.Patient;
import main.java.interview.treatment.plan.TreatmentPlan;
import main.java.interview.treatment.plan.TreatmentPlanService;
import main.java.interview.treatment.plan.TreatmentPlanServiceImpl;
...
public class TreatmentPlanServiceTest {
    ...
    public void ageInMonths() throws Exception {
        ...
        //Wrong Assert Statement. Should be 282 not 279
    }
